...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb" style="background:linear-gradient(to right,rgba(100,150,150, 1),rgba(150, 150, 150, 1))">
    ...
    <li class="breadcrumb-item active" aria-current="page"><a href="electronics.php" style="color:white;">Electronics Engineering</a></li>
          ...
          <div class="row align-items-center">
            <div class="col-12">
              <div class="row justify-content-center align-items-center text-center">
                <div class="col-lg-6">
                  <h1 data-aos="fade-up" data-aos-delay="0" class="text-white">Digital Signal Processing</h1>
                </div>
              </div>
            </div>
        ...
        <div class="row">
          <div class="col-lg-8 mb-5">
            ...
            <div class="mb-5">
              ...
              <p>This course will give you an in-depth knowledge of Digital Signal Processing.</p>
            </div>
